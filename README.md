...
- **Environment-driven weighting** — runtime surfaces transform `PROVIDER_LABEL`, `GPU_*`, and SLA hints into canonical fields before any α-WU math executes, blocking malformed metadata from corrupting totals.【F:docs/alpha-wu.md†L108-L156】
